...
As \nameref{sec:bottom-left-corners} but representing the top-right corner of each rectangle (\texttt{tr\_corners} or \texttt{t}). It is used to reduce the number of positions in which a rectangle can fall in, because it must be inside the bounding box.
...
\subsubsubsection*{Translation of \texttt{diffn}}
...
\subsubsubsection*{Translation of \texttt{all\_different}}
...
\subsubsection{Containment}
\subsubsubsection*{Reduce presents domains}
\subsubsubsection*{Areas summation}

\subsubsection{Positioning}
\subsubsubsection*{Translation of \texttt{count\_eq}}

\subsubsection{Stacking}
\subsubsubsection*{Translation of \texttt{cumulative}}
